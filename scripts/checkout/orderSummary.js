...
import formatCurrency, {currencyFormat} from './../utils/money.js';
...
export function renderOrderSummary() {
    ...
    <div class="cart-item-details-grid">
      ...
      <div class="cart-item-details">
        ...
        <div class="product-quantity">
          ...
          <input class="quantity-input js-quantity-input-link js-quantity-input-${matchingProduct.id}"  data-product-id = "${matchingProduct.id}">
    ...
    container.remove(); // remove the selected div element 
    updateCartQuantity();
    ...
    alert('Quantity must >= 0 and <= 1000');
    return;
    } else {
    ...
    document.querySelectorAll('.js-quantity-input-link ')
    .forEach((inputLink)=>{
    inputLink.addEventListener('keypress', (keyEvent)=>{
